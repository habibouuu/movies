...
export default function page() {
  ...
  return (
    <Container sx={{height:{xs:'400px', md:'500px', lg:'630px', mt:2}, display:'flex', flexDirection:'column'}}>
        <iframe sandbox="allow-scripts allow-same-origin" width="100%" height="100%" src={`https://vidfast.vc/movie/${params.id}`} title={params.movie+''} frameBorder="0" allow="" referrerPolicy="" allowFullScreen></iframe>
      <Box sx={{p:3}}/>
